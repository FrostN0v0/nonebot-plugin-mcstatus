### 本仓库Fork自[Nonebot Plugin MCStatus](https://github.com/nonepkg/nonebot-plugin-mcstatus)并借鉴了[ZombieFly的Fork](https://github.com/ZombieFly/nonebot-plugin-mcstatus)
